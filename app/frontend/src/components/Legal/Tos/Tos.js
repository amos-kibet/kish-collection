...
// Assets (images)
import terms from "../../../assets/undraw_Terms_re_6ak4.png";
...
function Tos() {
  return (
    <div className="container">
      ...
      <p>
        Welcome to <b>FarmCart</b> (“Company”, “we”, “our”, “us”)!
      </p>
      <p>
        These Terms of Service (“Terms”, “Terms of Service”) govern your use of
        our website located at <b>https://farmcart-27e45.web.app/</b> (together
        or individually “Service”) operated by <b>FarmCart</b>.
      </p>
      <p>
      ...
      <p>
        ...
        <b>farmcart20@gmail.com</b> so we can try to find a solution. These
      ...
      <p>
        ...
        following the unsubscribe link or by emailing at farmcart20@gmail.com.
      </p>
      <p>
        3. <b>Purchases</b>
      </p>
      ...
      <p>
        FarmCart has the right but not the obligation to monitor and edit all
        Content provided by users.
      </p>
      <p>
        In addition, Content found on or through this Service are the property
        of FarmCart or used with permission. You may not distribute, modify,
        transmit, reuse, download, re-post, copy, or use said Content, whether
      ...
      <p>
        ...
        FarmCart and its licensors. Service is protected by copyright,
      ...
      <p>
        ...
        to farmcart20@gmail.com, with the subject line: “Copyright Infringement”
      ...
      <p>
        You can contact our Copyright Agent via email at farmcart20@gmail.com.
      </p>
      <p>
        14. <b>Error Reporting and Feedback</b>
      </p>
      <p>
        You may provide us either directly at farmcart20@gmail.com or via third
      ...
      <p>
        ...
        are not owned or controlled by FarmCart.
      </p>
      <p>
        FarmCart has no control over, and assumes no responsibility for the
      ...
      <p>
        ...
        email: <b>farmcart20@gmail.com</b>.
      </p>
    </div>
  );
}
