...
import privacy_image from "../../../assets/privacy-policy.png";
  ...
  return (
    <div className="container">
      ...
      <h1>
        ...
        Privacy Policy
        <img src={privacy_image} alt={privacy_image} style={{
        objectFit: "cover",
        float: "right",
        width: 80,
        height: 60,
      ...
      <p>
        Welcome to <b> FarmCart</b>.
      </p>
      <p>
        <b>FarmCart</b> (“us”, “we”, or “our”) operates <b>https://farmcart-27e45.web.app/</b>{" "}
        (hereinafter referred to as <b>“Service”</b>).
      </p>
      <p>
        Our Privacy Policy governs your visit to <b>https://farmcart-27e45.web.app/</b>, and
      ...
      <p>
        <b>SERVICE</b> means the https://farmcart-27e45.web.app/ website operated by FarmCart.
      </p>
      <p>
      ...
      <p>FarmCart uses the collected data for various purposes:</p>
      ...
      <p>
        FarmCart will take all the steps reasonably necessary to ensure that
      ...
      <p>
        <b>
          ...
          consideration may be considered a “sale”. You are the only owner of
      ...
      <p>
        ...
        your request(s) by email: <b>fartcart20@gmail.com</b>.
      </p>
      <p>
      ...
      <p>
        15. <b>Behavioral Re-marketing</b>
      </p>
      <p>
        We may use re-marketing services to advertise on third party websites to
      ...
      <p>
        ...
        by email: <b>fartcart20@gmail.com</b>.
      </p>
    </div>
  );
}
